            ...
            <div className="container px-6 py-12 mx-auto">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div>
                        ...
                        <h1 className="mt-4 text-xl font-semibold text-gray-800 dark:text-white">Learn English</h1>

                        <p className="mt-2 text-gray-500 dark:text-gray-400">
                            You can experience various English words that are excerpted from  
                            <a href="http://random-word-api.herokuapp.com/home" className="text-blue-500 hover:text-blue-400"> Random Word API</a>
                            .
                        </p>
                    </div>
